...
const giveaway = document.querySelector('.giveaway-show')
const deadlines = document.querySelector('.deadline')
const items = document.querySelectorAll('.deadline-format h4')

const futureDate = new Date(2020,7,10,11,30,0)
...
giveaway.textContent = `Giveaway End On ${day}, ${dates} ${month}  ${year} ${hours}: ${minutes} `
...
function getRemainingTime(){
    ...
    if(t<0){
      ...
      deadlines.innerHTML = `<h3>Sorry, This Giveaway Has Expired</h3>`
    }
}
